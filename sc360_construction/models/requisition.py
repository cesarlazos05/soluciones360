...
class Requisition(models.Model):
    ...
    def _compute_totals(self):
        for req in self:
            req.amount_total = sum(req.line_ids.mapped('subtotal'))
...
class RequisitionLine(models.Model):
    ...
    fully_purchased = fields.Boolean(compute='_compute_purchased', store=True)
    ...
    def _compute_purchased(self):
        for line in self:
            ...
            if line.qty_purchased >= line.qty:
                ...
                line.fully_purchased = True
            elif line.qty_purchased > 0:
                line.line_status = 'partial'
                line.fully_purchased = False
            else:
