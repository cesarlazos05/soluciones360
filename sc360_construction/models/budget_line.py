...
class BudgetLine(models.Model):
    ...
    def _compute_execution(self):
        for line in self:
            # Solo considerar líneas de ODC confirmadas o completadas
            ...
            # Calcular recibido en valor (usando precio de compra promedio o P.U. del presupuesto)
    ...
    def _onchange_concept_template(self):
        """Copia datos del concepto del catálogo"""
    ...
    def action_create_requisition(self):
        """Crear requisición directamente desde esta línea de presupuesto"""
        self.ensure_one()
        return {
            'type': 'ir.actions.act_window',
